...
int main() {
    ...
    std::ifstream infile1("/data/100x1000x1000/trade9",std::ios::in | std::ios::binary);
    std::ifstream infile2("/data/team-10/my_ans_large/trade9",std::ios::in | std::ios::binary);
